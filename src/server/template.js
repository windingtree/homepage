export default (html, helmet) => `
    ...
    <head>
        ...
        <meta itemprop="image" content="https://windingtree.com/socialbg.png">

        <!-- Twitter Card data -->
        <meta name="twitter:card" content="https://windingtree.com/socialbg.png">
        ...
        <meta name="twitter:image:src" content="https://windingtree.com/socialbg.png">

        <!-- Open Graph data -->
        <meta property="og:title" content="Winding Tree - Decentralized Travel Ecosystem">
        <meta property="og:type" content="article">
        <meta property="og:image" content="https://windingtree.com/img/socialbg.png">
