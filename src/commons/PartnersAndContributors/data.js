...
import luftansaGroup from './images/lufthansa-group.png';
...
const quotes: CollaboratorType[] = [
  {
    name: 'nordicChoiceHotels',
    text: 'Nordic Choice Hotels is currently experimenting with the blockchain. Some of the rooms on Hobo have been made available on the blockchain platform Winding Tree, whose data can be used by third-party apps and sites that turn to the customers.',
  ...
  },
  {
    ...
    href: 'https://www.swiss.com/ready-takeoff-lufthansa-strikes-deal-blockchain-ico-startup/',
    imgSrc: swiss,
  },
  {
    name: 'luftansaGroup',
    text: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.',
    href: 'https://lufthansaGroup.com/2017/10/10/lufthansa-partners-with-a-blockchain-provider-in-an-investment-worth-testing/',
    imgSrc: luftansaGroup,
  },
  {
    name: 'rsk',
