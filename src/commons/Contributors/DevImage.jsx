...
const DevImage = (props: PropsType) => {
  ...
  return (
    <div className="devs-marquee-dev">
      <svg className="devs-marquee-dev-img" width="54" height="60" viewBox="0 0 54 60" xmlns="http://www.w3.org/2000/svg">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          ...
          <image mask="url(#mask2)" width="54" height="60" xlinkHref={img} />
        </g>
      </svg>
