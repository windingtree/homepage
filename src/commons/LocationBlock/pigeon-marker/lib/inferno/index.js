...
const _pin = require('./img/pin.png');

const _pin2 = _interopRequireDefault(_pin);

const _pin2x = require('./img/pin@2x.png');

const _pin2x2 = _interopRequireDefault(_pin2x);

const _pinHover = require('./img/pin-hover.png');

const _pinHover2 = _interopRequireDefault(_pinHover);

const _pinHover2x = require('./img/pin-hover@2x.png');
...
const { createVNode } = _infact.Inferno;
