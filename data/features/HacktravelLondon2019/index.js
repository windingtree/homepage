...
const Hacktravel = {
  header: {
    ...
    mainButtonLabel: 'Hackathon Program',
    mainButtonUrl: '/hacktravelprogram',
    secondaryButtons: [
      {
  ...
  about: {
    ...
    text: "#HackTravel hackathon is a unique opportunity for the most forward thinking travel industry players to come together and collaboratively tackle real world industry pain points.\n \nFollowing the success of our last two #HackTravel Prague & #HackTravel Lisbon hackathons, this time around we're adding more benefits, content and activities for our community to the most out of their participants.",
    buttons: [
      {
        ButtonLabel: '#HackTravel Lisbon Recap',
        ButtonUrl: 'https://blog.windingtree.com/2019-lisbon-hacktravel-technical-recap-509bcc9adcd7',
      },
      {
